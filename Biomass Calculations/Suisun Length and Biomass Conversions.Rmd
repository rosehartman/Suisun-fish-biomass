...
d.kim[, delete1 := NULL]
d.kim[, convert.fl2tl.kim := 1/convert.tl2fl.kim]
...
d.kim.unique.l2l <- unique(d.kim[, .(common, convert.fl2tl.kim, convert.tl2sl.kim)])
d.kim.unique.l2l[!is.na(convert.fl2tl.kim), kim.fl2tl := "T"]
d.kim.unique.l2l[!is.na(convert.tl2sl.kim), kim.tl2sl := "T"]
# drop the old numeric columns
d.kim.unique.l2l[, convert.fl2tl.kim := NULL]
d.kim.unique.l2l[, convert.tl2sl.kim := NULL]
# drop rows with no T values to get rid of duplicate American Shad row
d.kim.unique.l2l <- d.kim.unique.l2l[!is.na(kim.fl2tl) | !is.na(kim.tl2sl), ]
...
d.fx3.unique <- unique(d.fx3[species != "", .(species, common, convert.sl2tl.fx3, convert.fl2tl.fx3)][order(common)])
d.fx3.unique[, convert.tl2sl.fx3 := 1/convert.sl2tl.fx3]
d.fx3.unique.l2l <- d.fx3.unique[, .(common, convert.fl2tl.fx3, convert.sl2tl.fx3)]
d.fx3.unique.l2l[!is.na(convert.fl2tl.fx3), fx3.fl2tl := "T"]
d.fx3.unique.l2l[!is.na(convert.sl2tl.fx3), fx3.tl2sl := "T"]
d.fx3.unique.l2l[, convert.fl2tl.fx3 := NULL]
d.fx3.unique.l2l[, convert.sl2tl.fx3 := NULL]

rm(d.fx3)

merge(
  d.kim[, .(common, convert.fl2tl.kim, convert.sl2tl.kim)], 
  d.fx3.unique[, .(  common, convert.fl2tl.fx3, convert.sl2tl.fx3)], 
