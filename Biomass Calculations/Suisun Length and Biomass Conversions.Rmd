...
d.having.bioconversion <-  d.kimmerer[reference == "Kimmerer et al", .(common, dk)]
...
# Max proportion of catch per sample for each species
 ...
 t.catchcounts.summary1 <- t.catchcounts[, mean(species.proportion.persample), by = .(CommonName)]
    setnames(t.catchcounts.summary1, old = "V1", new = "species.proportion.persample.avg")
 t.catchcounts.summary2 <- t.catchcounts[, max(species.proportion.persample), by = .(CommonName)]
    setnames(t.catchcounts.summary2, old = "V1", new = "species.proportion.persample.max")
 t.catchcounts.summary <- t.catchcounts.summary1[t.catchcounts.summary2, on = .(CommonName)]

setkey(d.having.bioconversion, common)
setkey(t.catchcounts.summary, CommonName)
