...
PRODUCE LENGTH TO BIOMASS CONVERSION TABLES
```{r}
...
d.schneider <- fread("Schneider L-W Table.csv")
# note: for Schneider, log10(mass) = intercept + slope * log10(length)
setnames(d.schneider, 
         old = colnames(d.schneider),
         new = c(
            "common",
            "convert.biomass.exponent",
...
### DIAGNOSTIC ZONE ###
# str(d.suisun)
d.biomass.merge2[, .(common, convert.tl.sl, convert.tl.fl, convert.tl2sl.Kimmerer, convert.fl2tl.Kimmerer)]
